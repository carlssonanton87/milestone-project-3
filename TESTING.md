...
| UM-TS08              | Flash messages display            | Logout, then login.                                                                                                                       | Success/info messages appear for each event.                | Pass          | ![UM-TS08](readme_assets/images/manual_testing/UM-TS08.png) |
| UM-TS09              | Trade pages require login         | Log out and attempt to visit `/dashboard/` or `/trades/`.                                                                                 | Redirected to login page, flash message shown.              | Pass          | ![UM-TS09](readme_assets/images/manual_testing/UM-TS09.png) |
